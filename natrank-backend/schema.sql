...
CREATE TABLE `Match` (
  ...
  `team1_goals` tinyint unsigned NOT NULL,
  `team2_goals` tinyint unsigned NOT NULL,
  ...
  `team1_rank_change` smallint unsigned DEFAULT NULL,
  `team2_rank_change` smallint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `RankingEntry` (
  ...
  `rank_change` smallint unsigned DEFAULT NULL,
...
CREATE TABLE `TeamRank` (
  ...
  `change` smallint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `TeamRating` (
  ...
  `change` smallint unsigned NOT NULL,
